...
public class User {
    //Since this is protected, it is represented as # in the UML diagram,
    ...
    //I've learned that protected attributes are only visible within the class and its subclasses! :0
